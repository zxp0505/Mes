...
public class WSMainPresent extends WSRxPresent<WSMainView> {
    ...
    public void testServer() {
        mMainRequest.testServer(new HashMap<String, String>(), getView(), new WSRxDataCallBack<WSWorkStationVo>() {
            @Override
    ...
    public void getStationName() {
        mMainRequest.getStationName(new HashMap<String, String>(), getView(), new WSRxDataCallBack<WSWorkStationVo>() {
            @Override
            public void onSucess(WSWorkStationVo workStationVo) {
                if (getView() != null) {
